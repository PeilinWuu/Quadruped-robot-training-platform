...
export function createD6Telemetry(sequence: number): RobotTelemetry {
  ...
  return {
    ...
    command: {
      ...
      controllerAvailability: 'go2-kinematic-animation-v1',
    },
    locomotion: {
      controllerId: 'go2-kinematic-animation-v1', availability: 'available', state: 'standing',
      commandedForwardVelocity: 0, commandedLateralVelocity: 0, commandedYawRate: 0,
      integratedForwardVelocity: linearSpeed, integratedLateralVelocity: 0,
      integratedYawRate: wave(sequence, 2) * 0.01,
