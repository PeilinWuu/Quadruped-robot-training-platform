...
import { mockRobotService, mockSceneService, mockSensorService, mockTrainingService } from './mock'
import { realRobotService, realSceneService, realSensorService, realTrainingService } from './real'
