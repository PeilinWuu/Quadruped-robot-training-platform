...
#define BINDING_MESH_INSTANCE_TO_OBJ 21

// segmentation class IDs (method A: object/instance level)
#define SEG_ID_BACKGROUND 0
#define SEG_ID_SPLAT_SCENE 1
#define SEG_ID_MESH_INSTANCE_BASE 2
...
#define RTX_BINDING_OUTSEG 6            // segmentation ID buffer
...
struct PushConstant
{
  ...
  uint32_t objIndex;           // mesh model index in meshes[]
  uint32_t sceneInstanceIndex;  // index in instances[] for segmentation
};
