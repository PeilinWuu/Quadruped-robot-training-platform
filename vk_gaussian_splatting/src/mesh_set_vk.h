...
public:
  ...
  nvvk::Buffer                   instanceToObjIndexBuffer;  // maps scene instance index -> meshes[] index
...
public:
  ...
  // maps TLAS InstanceID (scene instance index) to meshes[] index for RTX closest hit
  void updateInstanceToObjIndexBuffer();
